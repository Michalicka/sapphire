...
describe('EditProjectMembersDialog container', () => {
  it('should return expected mapped state', () => {
    ...
    expect(mappedState.errors).toEqual(state.projects.errors.putProjectsMembers)
    expect(mappedState.loading).toBe(state.projects.loading.putProjectsMembers)
  ...
  it('should return expected mapped actions', () => {
    ...
    expect(dispatch.mock.calls[2][0]).toEqual(changeProjectsErrors('putProjectsMembers')({}))
